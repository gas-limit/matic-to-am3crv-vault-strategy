...
await vault.B_DepositIntoAAVE();
console.log("Deposit complete");


console.log("\n Checking Vault AAVE Token Balances");

const maDaiBalance = await vault.maDaiBalance();
console.log("Vault maDai Balance: ", ethers.utils.formatEther(maDaiBalance.toString()));


const maUSDCBalance = await vault.maUSDCBalance();
console.log("Vault maUSDC Balance: ", ethers.utils.formatEther(maUSDCBalance.toString()));

const maUSDTBalance = await vault.maUSDTBalance();
console.log("Vault maUSDC Balance: ", ethers.utils.formatEther(maUSDTBalance.toString()));

console.log("\n Providing Liquidity to Curve..");
console.log("Approving Tokens");
await vault.C_DepositIntoCurve();

const am3crvBalance = await vault.am3CRVTBalance();
console.log("Vault am3crv Balance:", ethers.utils.formatEther(am3crvBalance.toString()));
