...
// ========================================= internal utility methods ✨
    ...
    function convertEthToStable(uint tokenAmount, address[] memory stablecoin) internal {

        uint deadline = block.timestamp + 15; // using 'now' for convenience, for mainnet pass deadline from frontend!
        uniswapRouter.swapETHForExactTokens{ value: msg.value }(tokenAmount, stablecoin, address(this), deadline);
